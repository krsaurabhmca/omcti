...
const AttractiveLoginScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <LinearGradient
        colors={['#234785', '#1a3666', '#3a5fa0', '#ffeb44']}
          ...
          >
            ...
            <View style={styles.headerContainer}>
              ...
              <View style={styles.titleContainer}>
                <Text style={styles.title}>IMMENSE</Text>
                <View style={styles.subtitleContainer}>
                  <Ionicons name="star" size={16} color="#ffeb44" />
                  <Text style={styles.subtitle}>Institute of Technology & Management</Text>
                  <Ionicons name="star" size={16} color="#ffeb44" />
                </View>
              </View>
            </View>
            ...
            <View style={styles.formContainer}>
              ...
              >
                ...
                <View style={styles.inputGroup}>
                  ...
                  >
                    <LinearGradient
                      colors={focusedInput === 'username' ? ['#234785', '#3a5fa0'] : ['#f8fafc', '#ffffff']}
                    ...
                    >
                      <View style={styles.inputContent}>
                        ...
                        <TextInput
                          ...
                          placeholderTextColor={focusedInput === 'username' ? 'rgba(255, 235, 68, 0.7)' : '#9ca3af'}
                          value={username}
                ...
                <View style={styles.inputGroup}>
                  ...
                  >
                    <LinearGradient
                      colors={focusedInput === 'password' ? ['#234785', '#3a5fa0'] : ['#f8fafc', '#ffffff']}
                    ...
                    >
                      <View style={styles.inputContent}>
                        ...
                        <TextInput
                          ...
                          placeholderTextColor={focusedInput === 'password' ? 'rgba(255, 235, 68, 0.7)' : '#9ca3af'}
                          value={password}
            ...
            <View style={styles.footer}>
              <Text style={styles.footerText}>© 2017-25 IITM • Made with ❤️ for learners</Text>
            </View>
          </Animated.View>
        </KeyboardAvoidingView>
      </LinearGradient>
